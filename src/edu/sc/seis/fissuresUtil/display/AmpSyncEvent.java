...
/**
 * AmpSyncEvent creates an object that encapsulates the change the user
...
public class AmpSyncEvent {
    /**
     * Creates a new <code>AmpSyncEvent</code> instance.
     *
     ...
     */
    public AmpSyncEvent (double beginShift, double endShift, boolean isAdjusting){
