...
/**
 * RMedianAmpConfig sets a range equal to the largest difference between the minimum and maximum of a seismogram it contains.  Each seismogram
 * has its amplituded centered around its minimum subtracted from its maximum divided by two.  These amplitude ranges can be set to be 
 * over the full time of the seismograms, or only a certain interval specified by a TimeRangeConfig object given to this amp config
 *
 *
...
public class RMedianAmpConfig extends AbstractAmpRangeConfig{
