...
public class TimeBorder extends Border implements TitleProvider{
    ...
    private static double[] secDivs = { .1, .5, 1, 3, 5, 10, 20, 30 };
    ...
    private class TimeBorderFormat extends BorderFormat{
        ...
        public UnitImpl getDivUnit() { return UnitImpl.MILLISECOND; }
