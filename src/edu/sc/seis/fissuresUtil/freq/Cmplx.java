...
public class Cmplx {
    ...
    *
    *  isign =  1  replace data by FFT
    *        = -1  replace data by inverse FFT
    *
    *  data  pseudo-complex array of length nn input as real pairs
    *  nn    integer power of 2
    */
