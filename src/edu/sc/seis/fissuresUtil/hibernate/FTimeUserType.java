...
public class FTimeUserType implements CompositeUserType {
    ...
    throws HibernateException, SQLException { 
        ...
        MicroSecondDate out = new MicroSecondDate(first, second);
        return ( first==null ) ? null : out.getFissuresTime();
    }
    ...
    throws HibernateException, SQLException {
        if (value == null) {
            ...
            Hibernate.INTEGER.nullSafeSet(st, new Integer(((Time)value).leap_seconds_version), index+1);
        }
    }
