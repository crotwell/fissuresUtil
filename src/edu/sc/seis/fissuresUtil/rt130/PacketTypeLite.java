 ...
 */
public class PacketTypeLite {

    public PacketTypeLite() {
        encoded_data = new EncodedData[0];
    }

    public PacketTypeLite(DataInput in) throws IOException,
            RT130FormatException {
        encoded_data = new EncodedData[0];
        this.readNextPacket(in);
    }

    public PacketTypeLite(PacketTypeLite original) {
        ...
        if(original.dP != null) {
            this.dP = new DataPacketLite(original.dP);
        }
